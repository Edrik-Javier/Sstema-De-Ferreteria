...
void M_Ventas(){
	...
	switch(seleccion){
		...
		case 3:
			...
			sql3 = "INSERT INTO Ventas (id_producto,id_cliente, id_empleado, Descripcion, Cantidad, Fecha,Hora, Total) VALUES ("+idproducto+","+idcliente+", "+idempleado+", '"+descripcion+"', "+cantidad+", '"+fecha+"','"+hora+"',"+total+");";
			SQL_operaciones(sql3);
			cin.ignore();
		break; 
		default:
            cout << "Algo salio mal, seleccione de nuevo..." << endl;
            break;           
	};
